...
export default function AudioPlay({resource, url, style}: { resource: Resource, url: string, style: StyleProp<ViewStyle> }) {
                ...
                <NativeView style={ [ styles.buttonContainer, style ] }>
                    ...
                    </NativeView>
                    {
                        audioStatus?.isPlaying
                            ?
                            <NativeButton style={ {backgroundColor: 'white', borderWidth: 1} } textStyle={ {color: 'black'} } onPress={ () => audioSound?.pauseAsync() }>暂停</NativeButton>
                            :
                            <NativeButton style={ {backgroundColor: 'white', borderWidth: 1} } textStyle={ {color: 'black'} } onPress={ playSound }>播放</NativeButton>
                    }
                </NativeView>
            </>
        )
